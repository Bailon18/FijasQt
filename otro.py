...
from PySide2.QtGui import QIcon, QFont, QPalette, QImage, QPixmap
from PySide2.QtCore import (Qt, QDir, QFile, QFileInfo, QPropertyAnimation, QRect,
                          QAbstractAnimation, QTranslator, QLocale, QLibraryInfo)
from PySide2.QtWidgets import (QApplication, QMainWindow, QWidget, QPushButton, QMessageBox,
...
class Widgets(QWidget):
    ...
    def initUI(self):
      ...
      # =================== BOTONES (QPUSHBUTTON) ==================
        ...
        self.buttonSiguiente = QPushButton(">", self)s
  ...
  # ======================= FUNCIONES ==============================
    ...
    def Cargar(self):
        ...
        if nombreImagen:
            ...
            print('nombreImagen prec',nombreImagen)
            ...
            if labelConImagen:
                ...
                print('labelMostrarImagen',labelMostrarImagen)
            else:
    ...
    def Eliminar(self):
        ...
        print('labelConImagen',labelConImagen)
